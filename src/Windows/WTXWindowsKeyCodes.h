...
#define KEY_RETURN XK_Return&0xFF

#define KEY_SHIFT XK_Shift_L||XK_Shift_R&0xFF

#define KEY_CONTROL XK_Control_L||XK_Control_R&0xFF
#define KEY_CTRL XK_Control_L||XK_Control_R&0xFF

#define KEY_ALTERNATE XK_Alt_L||XK_Alt_R&0xFF
#define KEY_ALT XK_Alt_L||XK_Alt_R&0xFF

#define KEY_PAUSE XK_Pause&0xFF

#define KEY_CAPSLOCK XK_Caps_Lock&0xFF
#define KEY_CAPITALLOCK XK_Caps_Lock&0xFF

#define KEY_ESCAPE XK_Escape&0xFF
#define KEY_ESC XK_Escape&0xFF

#define KEY_SPACE XK_space&0xFF

#define KEY_PGUP XK_Page_Up&0xFF
#define KEY_PAGEUP XK_Page_Down&0xFF

#define KEY_PGDN XK_Page_Down&0xFF
#define KEY_PAGEDOWN XK_Page_Down&0xFF

#define KEY_END XK_End&0xFF
#define KEY_HOME XK_Home&0xFF

#define KEY_LEFT XK_Left&0xFF
#define KEY_LEFTARROW XK_Left&0xFF

#define KEY_RIGHT XK_Right & 0xFF
#define KEY_RIGHTARROW XK_Right&0xFF

#define KEY_UP XK_Up & 0xFF
#define KEY_UPARROW XK_Up&0xFF

#define KEY_DOWN XK_Down & 0xFF
#define KEY_DOWNARROW XK_Down&0xFF

#define KEY_SELECT XK_Select&0xFF

#define KEY_EARLYPRINT XK_Print&0xFF
#define KEY_EARLYPRINTSCREEN XK_Print&0xFF

#define KEY_EXECUTE XK_Execute&0xFF

#define KEY_PRINT XK_Print&0xFF
#define KEY_PRINTSCREEN XK_Print&0xFF

#define KEY_INS XK_Insert&0xFF
#define KEY_INSERT XK_Insert&0xFF

#define KEY_DEL XK_Delete&0xFF
#define KEY_DELETE XK_Delete&0xFF

#define KEY_HELP XK_Help&0xFF

#define KEY_0 XK_0&0xFF
#define KEY_1 XK_1&0xFF
#define KEY_2 XK_2&0xFF
#define KEY_3 XK_3&0xFF
#define KEY_4 XK_4&0xFF
#define KEY_5 XK_5&0xFF
#define KEY_6 XK_6&0xFF
#define KEY_7 XK_7&0xFF
#define KEY_8 XK_8&0xFF
#define KEY_9 XK_9&0xFF

#define KEY_A XK_A&0xFF
#define KEY_B XK_B&0xFF
#define KEY_C XK_C&0xFF
#define KEY_D XK_D&0xFF
#define KEY_E XK_E&0xFF
#define KEY_F XK_F&0xFF
#define KEY_G XK_G&0xFF
#define KEY_H XK_H&0xFF
#define KEY_I XK_I&0xFF
#define KEY_J XK_J&0xFF
#define KEY_K XK_K&0xFF
#define KEY_L XK_L&0xFF
#define KEY_M XK_M&0xFF
#define KEY_N XK_N&0xFF
#define KEY_O XK_O&0xFF
#define KEY_P XK_P&0xFF
#define KEY_Q XK_Q&0xFF
#define KEY_R XK_R&0xFF
#define KEY_S XK_S&0xFF
#define KEY_T XK_T&0xFF
#define KEY_U XK_U&0xFF
#define KEY_V XK_V&0xFF
#define KEY_W XK_W&0xFF
#define KEY_X XK_X&0xFF
#define KEY_Y XK_Y&0xFF
#define KEY_Z XK_Z&0xFF
