	...
	float liRange;
     if(mpString[liCount]!=32)
     {
		 liRange=IMF_FONT_SCALE*(cFont::Character(mpString[liCount])); //(or /64)
          ...
          glMultiTexCoord2f(GL_TEXTURE0,0,liRange+IMF_FONT_SCALE);   glVertex3f(-mfWidth*(liCount-0.5f),lfHeight,1.0f);
          glMultiTexCoord2f(GL_TEXTURE0,0,liRange);            glVertex3f(-mfWidth*(liCount-0.5f),-lfHeight,1.0f);
          glMultiTexCoord2f(GL_TEXTURE0,1,liRange);            glVertex3f(-mfWidth*(liCount+0.5f),-lfHeight,1.0f);
          glMultiTexCoord2f(GL_TEXTURE0,1,liRange+IMF_FONT_SCALE);   glVertex3f(-mfWidth*(liCount+0.5f),lfHeight,1.0f);
