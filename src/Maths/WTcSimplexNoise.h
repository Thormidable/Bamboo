 ...
 * on some platforms. A templatized version of cSimplexNoise could be useful.
 */

/**
* \brief Simplex Noise Generator. Based on code by Stefan Gustavson (stegu@itn.liu.se).
* Call any of the functions Noise to return the value at that point in the required dimensions.
*/
class cSimplexNoise{
