 ...
 * An instance of cMomentum must be linked to a matrix. It will only update when the function Update() is called.
 * */
class cMomentum
{
 cMatrix4 *mpMatrix;
...
public:
    ...
    void EqualsRelative(cMomentum *lpOther,cMatrix4 *lcThisPos,cMatrix4 *lcOtherPos);

    void Equals(cMomentum *lpOther);
