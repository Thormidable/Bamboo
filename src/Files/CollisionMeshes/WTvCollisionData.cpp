...
/*
void cCompoundCollision::AddType(cSphereCollision *lpSphere)
{
    Add(lpSphere);
};
void cCompoundCollision::AddType(cMeshCollision *lpMesh)
{
    Add(lpMesh);
};
void cCompoundCollision::AddType(cBeamCollision *lpBeam)
{
